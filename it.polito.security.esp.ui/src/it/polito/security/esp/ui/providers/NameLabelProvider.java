package it.polito.security.esp.ui.providers;
...
import it.polito.security.esp.util.StyleType;
import it.polito.security.esp.util.StyledText;
import it.polito.security.esp.util.Styles;
	...
	public StyledText getStyledText(Object element)
	{
		...
		else if (element instanceof Solution)
		{
			...
			if(solution.getFirstLevelSolution()==null)
				return Styles.format("Solution " + solution.getId() + " [score = " + solution.getL1pScore() + "]", null, 0, StyleType.NORMAL);
			else
				return Styles.format("Solution " + solution.getId() + " (" + solution.getFirstLevelSolution().getId() + ") " +
						"[score = " + solution.getL1pScore() + "]", null, 0, StyleType.NORMAL);
		}
		else if (element instanceof SolutionSequence)
