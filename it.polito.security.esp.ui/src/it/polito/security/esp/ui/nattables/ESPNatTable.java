...
/**
 * The ESP standard table.
 * @author Daniele Canavese
 *
 * @param <T>
 *            The table content class.
 */
public class ESPNatTable<T> extends NatTable
{
	/** The event list. **/
	 ...
	 **/
	public ESPNatTable(Composite parent, Collection<T> content, String[] propertyNames, Map<String, String> propertyToLabelMap,
			Format<T> format, ExpansionModel<T> expansionModel) throws MalformedURLException
	{
		...
		configRegistry.registerConfigAttribute(CellConfigAttributes.DISPLAY_CONVERTER, new ESPDisplayConverter());
		...
		CellPainterDecorator cellPainter = new CellPainterDecorator(new ESPPainter(), CellEdgeEnum.LEFT, new ImagePainter());
		...
		Style disabledAssetStyle = new Style();
		disabledAssetStyle.setAttributeValue(CellStyleAttributes.BACKGROUND_COLOR, new Color(Display.getDefault(), 100, 100, 100));
		disabledAssetStyle.setAttributeValue(CellStyleAttributes.FOREGROUND_COLOR, new Color(Display.getDefault(), 222, 222, 222));
		configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_STYLE, disabledAssetStyle, DisplayMode.NORMAL, "disabledAsset");
