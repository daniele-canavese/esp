 ...
 * </p>
 * <ul>
 *   <li>{@link it.polito.security.esp.kb.impl.ProtectionInstantiationImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.polito.security.esp.kb.impl.ProtectionInstantiationImpl#getProtection <em>Protection</em>}</li>
 *   <li>{@link it.polito.security.esp.kb.impl.ProtectionInstantiationImpl#getVariableAnnotation <em>Variable Annotation</em>}</li>
 ...
 *   <li>{@link it.polito.security.esp.kb.impl.ProtectionInstantiationImpl#getServerMemoryOverhead <em>Server Memory Overhead</em>}</li>
 *   <li>{@link it.polito.security.esp.kb.impl.ProtectionInstantiationImpl#getNetworkOverhead <em>Network Overhead</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProtectionInstantiationImpl extends MinimalEObjectImpl.Container implements ProtectionInstantiation
{
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__NAME, oldName, name));
	}
	...
	public void setProtection(Protection newProtection)
	{
		if (newProtection != eInternalContainer() || (eContainerFeatureID() != KbPackage.PROTECTION_INSTANTIATION__PROTECTION && newProtection != null))
		{
			...
			if (newProtection != null)
				msgs = ((InternalEObject)newProtection).eInverseAdd(this, KbPackage.PROTECTION__INSTANTIATIONS, Protection.class, msgs);
			msgs = basicSetProtection(newProtection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__PROTECTION, newProtection, newProtection));
	}
	...
	public void setVariableAnnotation(String newVariableAnnotation)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__VARIABLE_ANNOTATION, oldVariableAnnotation, variableAnnotation));
	}
	...
	public void setCodeAnnotation(String newCodeAnnotation)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__CODE_ANNOTATION, oldCodeAnnotation, codeAnnotation));
	}
	...
	public void setVerifierAnnotation(String newVerifierAnnotation)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__VERIFIER_ANNOTATION, oldVerifierAnnotation, verifierAnnotation));
	}
	...
	public void setAttestatorAnnotation(String newAttestatorAnnotation)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__ATTESTATOR_ANNOTATION, oldAttestatorAnnotation, attestatorAnnotation));
	}
	...
	public void setClientTimeOverhead(String newClientTimeOverhead)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__CLIENT_TIME_OVERHEAD, oldClientTimeOverhead, clientTimeOverhead));
	}
	...
	public void setServerTimeOverhead(String newServerTimeOverhead)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__SERVER_TIME_OVERHEAD, oldServerTimeOverhead, serverTimeOverhead));
	}
	...
	public void setClientMemoryOverhead(String newClientMemoryOverhead)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__CLIENT_MEMORY_OVERHEAD, oldClientMemoryOverhead, clientMemoryOverhead));
	}
	...
	public void setServerMemoryOverhead(String newServerMemoryOverhead)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__SERVER_MEMORY_OVERHEAD, oldServerMemoryOverhead, serverMemoryOverhead));
	}
	...
	public void setNetworkOverhead(String newNetworkOverhead)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.PROTECTION_INSTANTIATION__NETWORK_OVERHEAD, oldNetworkOverhead, networkOverhead));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case KbPackage.PROTECTION_INSTANTIATION__VARIABLE_ANNOTATION:
				return getVariableAnnotation();
			case KbPackage.PROTECTION_INSTANTIATION__CODE_ANNOTATION:
				return getCodeAnnotation();
			case KbPackage.PROTECTION_INSTANTIATION__VERIFIER_ANNOTATION:
			...
			case KbPackage.PROTECTION_INSTANTIATION__CLIENT_MEMORY_OVERHEAD:
				return getClientMemoryOverhead();
			case KbPackage.PROTECTION_INSTANTIATION__SERVER_MEMORY_OVERHEAD:
				return getServerMemoryOverhead();
			case KbPackage.PROTECTION_INSTANTIATION__NETWORK_OVERHEAD:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			...
			case KbPackage.PROTECTION_INSTANTIATION___TO_STRING:
				return toString();
		}
