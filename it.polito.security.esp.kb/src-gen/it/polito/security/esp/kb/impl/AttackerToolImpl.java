 ...
 * </p>
 * <ul>
 *   <li>{@link it.polito.security.esp.kb.impl.AttackerToolImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.polito.security.esp.kb.impl.AttackerToolImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link it.polito.security.esp.kb.impl.AttackerToolImpl#getExpertise <em>Expertise</em>}</li>
 *   <li>{@link it.polito.security.esp.kb.impl.AttackerToolImpl#getCost <em>Cost</em>}</li>
 *   <li>{@link it.polito.security.esp.kb.impl.AttackerToolImpl#isEnabled <em>Enabled</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttackerToolImpl extends MinimalEObjectImpl.Container implements AttackerTool
{
	...
	{
		return KbPackage.Literals.ATTACKER_TOOL;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.ATTACKER_TOOL__NAME, oldName, name));
	}
	...
	public EList<AttackerToolType> getTypes()
	{
		if (types == null)
		{
			types = new EObjectResolvingEList<AttackerToolType>(AttackerToolType.class, this, KbPackage.ATTACKER_TOOL__TYPES);
		}
		return types;
	}
	...
	public void setExpertise(ExpertiseLevel newExpertise)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.ATTACKER_TOOL__EXPERTISE, oldExpertise, expertise));
	}
	...
	public void setCost(int newCost)
	{
		...
		cost = newCost;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.ATTACKER_TOOL__COST, oldCost, cost));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case KbPackage.ATTACKER_TOOL__NAME:
				return getName();
			case KbPackage.ATTACKER_TOOL__TYPES:
				return getTypes();
			case KbPackage.ATTACKER_TOOL__EXPERTISE:
				return getExpertise();
			case KbPackage.ATTACKER_TOOL__COST:
				return getCost();
			case KbPackage.ATTACKER_TOOL__ENABLED:
				return isEnabled();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			case KbPackage.ATTACKER_TOOL___HASH_CODE:
				return hashCode();
			case KbPackage.ATTACKER_TOOL___EQUALS__OBJECT:
