...
public class KbPackageImpl extends EPackageImpl implements KbPackage
{
	 ...
	 * @generated
	 */
	private EClass attackStepProbabilityEClass = null;
	 ...
	 * @generated
	 */
	private EEnum fitterTypeEEnum = null;
	 ...
	 * @see it.polito.security.esp.kb.KbPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static KbPackage init()
	{
		...
		theKbPackage.createPackageContents();

		// Initialize created meta-data
		theKbPackage.initializePackageContents();
	...
	public void createPackageContents()
	{
		...
		createEReference(modelEClass, MODEL__ATTACK_STEP_PROBABILITIES);
		...
		createEAttribute(applicationPartEClass, APPLICATION_PART__DATUM_LOWER_BOUND);
		createEAttribute(applicationPartEClass, APPLICATION_PART__DATUM_UPPER_BOUND);
		...
		createEAttribute(applicationPartEClass, APPLICATION_PART__DISABLED_ASSET);
		...
		createEAttribute(applicationPartEClass, APPLICATION_PART__CONTAINS_IFDEF);
		...
		createEOperation(useTargetEClass, USE_TARGET___TO_STRING);
		...
		createEReference(attackStepEClass, ATTACK_STEP__APPLICATION_PARTS);
		...
		createEReference(attackStepTypeEClass, ATTACK_STEP_TYPE__PROBABILITIES);
		...
		attackStepProbabilityEClass = createEClass(ATTACK_STEP_PROBABILITY);
		createEAttribute(attackStepProbabilityEClass, ATTACK_STEP_PROBABILITY__NAME);
		createEAttribute(attackStepProbabilityEClass, ATTACK_STEP_PROBABILITY__EXPERTISE);
		createEAttribute(attackStepProbabilityEClass, ATTACK_STEP_PROBABILITY__PROBABILITY);
		createEOperation(attackStepProbabilityEClass, ATTACK_STEP_PROBABILITY___HASH_CODE);
		createEOperation(attackStepProbabilityEClass, ATTACK_STEP_PROBABILITY___EQUALS__OBJECT);
		...
		createEAttribute(preferencesEClass, PREFERENCES__ESP_PATCH_FILE);
		createEAttribute(preferencesEClass, PREFERENCES__ESP_JSON_FILE);
		...
		createEAttribute(preferencesEClass, PREFERENCES__METRICS_TRANSFORMATION_DEGREE);
		createEAttribute(preferencesEClass, PREFERENCES__METRICS_PSEUDO_INVERSE_SENSITIVITY);
		createEAttribute(preferencesEClass, PREFERENCES__METRICS_DERIVATIVE_SENSITIVITY);
		createEAttribute(preferencesEClass, PREFERENCES__METRICS_FITTER);
		createEAttribute(preferencesEClass, PREFERENCES__METRICS_NON_LINEAR_MAXIMUM_ITERATIONS);
		createEAttribute(preferencesEClass, PREFERENCES__METRICS_NON_LINEAR_STEP_SIZE);
		createEAttribute(preferencesEClass, PREFERENCES__METRICS_NON_LINEAR_MINIMUM_ERROR);
		createEAttribute(preferencesEClass, PREFERENCES__METRICS_NON_LINEAR_MINIMUM_CHANGE);
		...
		createEAttribute(preferencesEClass, PREFERENCES__MAX_ATTESTATORS_PER_PROTECTION_INSTANTIATION);
		...
		createEAttribute(preferencesEClass, PREFERENCES__L1P_MULTI_TREE_MULTIPLIER);
		...
		createEAttribute(preferencesEClass, PREFERENCES__L1P_FUTILITY_MARGIN);
		createEAttribute(preferencesEClass, PREFERENCES__L1P_EXTENDED_FUTILITY_MARGIN);
		createEAttribute(preferencesEClass, PREFERENCES__L1P_RAZORING_MARGIN);
		...
		createEAttribute(preferencesEClass, PREFERENCES__L2P_START_FROM_L1P_SOLUTION);
		...
		createEAttribute(appliedProtectionInstantiationEClass, APPLIED_PROTECTION_INSTANTIATION__VARIABLE_ANNOTATION);
		...
		createEReference(solutionEClass, SOLUTION__ATTACK_PATHS);
		...
		createEAttribute(solutionEClass, SOLUTION__L1P_SCORE);
		createEAttribute(solutionEClass, SOLUTION__L1P_TIME);
		createEAttribute(solutionEClass, SOLUTION__L2P_SCORE);
		createEAttribute(solutionEClass, SOLUTION__L2P_TIME);
		createEAttribute(solutionEClass, SOLUTION__CLIENT_TIME_OVERHEAD);
		createEAttribute(solutionEClass, SOLUTION__SERVER_TIME_OVERHEAD);
		createEAttribute(solutionEClass, SOLUTION__CLIENT_MEMORY_OVERHEAD);
		createEAttribute(solutionEClass, SOLUTION__SERVER_MEMORY_OVERHEAD);
		createEAttribute(solutionEClass, SOLUTION__NETWORK_OVERHEAD);
		...
		createEOperation(codeBlockEClass, CODE_BLOCK___TO_STRING);
		...
		fitterTypeEEnum = createEEnum(FITTER_TYPE);
	...
	public void initializePackageContents()
	{
		...
		initEReference(getModel_AttackStepProbabilities(), this.getAttackStepProbability(), null, "attackStepProbabilities", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getApplicationPart_DatumLowerBound(), theEcorePackage.getEInt(), "datumLowerBound", null, 0, 1, ApplicationPart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getApplicationPart_DatumUpperBound(), theEcorePackage.getEInt(), "datumUpperBound", null, 0, 1, ApplicationPart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getApplicationPart_DisabledAsset(), theEcorePackage.getEBoolean(), "disabledAsset", null, 0, 1, ApplicationPart.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getApplicationPart_ContainsIfdef(), theEcorePackage.getEBoolean(), "containsIfdef", null, 0, 1, ApplicationPart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getUseTarget__ToString(), theEcorePackage.getEString(), "toString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getAttackStep_ApplicationParts(), this.getApplicationPart(), null, "applicationParts", null, 0, -1, AttackStep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAttackStepType_Probabilities(), this.getAttackStepProbability(), null, "probabilities", null, 0, -1, AttackStepType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(attackStepProbabilityEClass, AttackStepProbability.class, "AttackStepProbability", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAttackStepProbability_Name(), theEcorePackage.getEString(), "name", null, 0, 1, AttackStepProbability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttackStepProbability_Expertise(), this.getExpertiseLevel(), "expertise", null, 0, 1, AttackStepProbability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttackStepProbability_Probability(), this.getLevel(), "probability", null, 0, 1, AttackStepProbability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getAttackStepProbability__HashCode(), theEcorePackage.getEInt(), "hashCode", 0, 1, !IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getAttackStepProbability__Equals__Object(), theEcorePackage.getEBoolean(), "equals", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEJavaObject(), "object", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getPreferences_MetricsTransformationDegree(), theEcorePackage.getEInt(), "metricsTransformationDegree", "4", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_MetricsPseudoInverseSensitivity(), theEcorePackage.getEDouble(), "metricsPseudoInverseSensitivity", "1e-9", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_MetricsDerivativeSensitivity(), theEcorePackage.getEDouble(), "metricsDerivativeSensitivity", "1e-9", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_MetricsFitter(), this.getFitterType(), "metricsFitter", "nonLinearFitter", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_MetricsNonLinearMaximumIterations(), theEcorePackage.getEInt(), "metricsNonLinearMaximumIterations", "10000", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_MetricsNonLinearStepSize(), theEcorePackage.getEDouble(), "metricsNonLinearStepSize", "0.01", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_MetricsNonLinearMinimumError(), theEcorePackage.getEDouble(), "metricsNonLinearMinimumError", "1e-9", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_MetricsNonLinearMinimumChange(), theEcorePackage.getEDouble(), "metricsNonLinearMinimumChange", "1e-9", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPreferences_MaxAttestatorsPerProtectionInstantiation(), theEcorePackage.getEInt(), "maxAttestatorsPerProtectionInstantiation", "3", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPreferences_ClientMemoryOverhead(), theEcorePackage.getEInt(), "clientMemoryOverhead", "10240", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_ServerMemoryOverhead(), theEcorePackage.getEInt(), "serverMemoryOverhead", "10240", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_NetworkOverhead(), theEcorePackage.getEInt(), "networkOverhead", "1048576", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pSolutionsCount(), theEcorePackage.getEInt(), "l1pSolutionsCount", "3", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPreferences_L1pClientTimeOverheadPercentage(), theEcorePackage.getEDouble(), "l1pClientTimeOverheadPercentage", "75", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pServerTimeOverheadPercentage(), theEcorePackage.getEDouble(), "l1pServerTimeOverheadPercentage", "-75", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pClientMemoryOverheadPercentage(), theEcorePackage.getEDouble(), "l1pClientMemoryOverheadPercentage", "-75", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pServerMemoryOverheadPercentage(), theEcorePackage.getEDouble(), "l1pServerMemoryOverheadPercentage", "-75", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pNetworkOverheadPercentage(), theEcorePackage.getEDouble(), "l1pNetworkOverheadPercentage", "-75", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPreferences_L1pUseACTCPrecedences(), theEcorePackage.getEBoolean(), "l1pUseACTCPrecedences", "false", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pIgnoreApplicationPartOrder(), theEcorePackage.getEBoolean(), "l1pIgnoreApplicationPartOrder", "false", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPreferences_L1pMultiTreeMultiplier(), theEcorePackage.getEDouble(), "l1pMultiTreeMultiplier", "1.0", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pInitialAlpha(), theEcorePackage.getEDouble(), "l1pInitialAlpha", "NaN", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pInitialBeta(), theEcorePackage.getEDouble(), "l1pInitialBeta", "NaN", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pResearchDelta(), theEcorePackage.getEDouble(), "l1pResearchDelta", "5000.0", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPreferences_L1pFutilityMargin(), theEcorePackage.getEDouble(), "l1pFutilityMargin", "1.0", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pExtendedFutilityMargin(), theEcorePackage.getEDouble(), "l1pExtendedFutilityMargin", "2.0", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPreferences_L1pRazoringMargin(), theEcorePackage.getEDouble(), "l1pRazoringMargin", "4.0", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPreferences_L2pStartFromL1pSolution(), theEcorePackage.getEBoolean(), "l2pStartFromL1pSolution", "false", 0, 1, Preferences.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAppliedProtectionInstantiation_VariableAnnotation(), theEcorePackage.getEString(), "variableAnnotation", null, 0, 1, AppliedProtectionInstantiation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSolution_AttackPaths(), this.getAttackPath(), null, "attackPaths", null, 0, -1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSolution_L1pScore(), theEcorePackage.getEDouble(), "l1pScore", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolution_L1pTime(), theEcorePackage.getEDouble(), "l1pTime", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolution_L2pScore(), theEcorePackage.getEDouble(), "l2pScore", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolution_L2pTime(), theEcorePackage.getEDouble(), "l2pTime", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolution_ClientTimeOverhead(), theEcorePackage.getEDouble(), "clientTimeOverhead", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolution_ServerTimeOverhead(), theEcorePackage.getEDouble(), "serverTimeOverhead", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolution_ClientMemoryOverhead(), theEcorePackage.getEDouble(), "clientMemoryOverhead", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolution_ServerMemoryOverhead(), theEcorePackage.getEDouble(), "serverMemoryOverhead", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolution_NetworkOverhead(), theEcorePackage.getEDouble(), "networkOverhead", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getCodeBlock__ToString(), theEcorePackage.getEString(), "toString", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		addEEnumLiteral(actionTypeEEnum, ActionType.ATTEST);
		addEEnumLiteral(actionTypeEEnum, ActionType.ACCESS);

		initEEnum(fitterTypeEEnum, FitterType.class, "FitterType");
		addEEnumLiteral(fitterTypeEEnum, FitterType.LINEAR);
		addEEnumLiteral(fitterTypeEEnum, FitterType.NON_LINEAR);
		addEEnumLiteral(fitterTypeEEnum, FitterType.MARQUARDT);
