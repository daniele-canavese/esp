 ...
 * </p>
 * <ul>
 *   <li>{@link it.polito.security.esp.kb.impl.AttackerImpl#getExpertise <em>Expertise</em>}</li>
 *   <li>{@link it.polito.security.esp.kb.impl.AttackerImpl#getBudgetLimit <em>Budget Limit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttackerImpl extends MinimalEObjectImpl.Container implements Attacker
{
	...
	{
		return KbPackage.Literals.ATTACKER;
	}
	...
	public void setExpertise(ExpertiseLevel newExpertise)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.ATTACKER__EXPERTISE, oldExpertise, expertise));
	}
	...
	public void setBudgetLimit(Integer newBudgetLimit)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KbPackage.ATTACKER__BUDGET_LIMIT, oldBudgetLimit, budgetLimit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case KbPackage.ATTACKER__EXPERTISE:
				return getExpertise();
			case KbPackage.ATTACKER__BUDGET_LIMIT:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
	{
		switch (operationID)
		{
			case KbPackage.ATTACKER___HASH_CODE:
				return hashCode();
			case KbPackage.ATTACKER___EQUALS__OBJECT:
