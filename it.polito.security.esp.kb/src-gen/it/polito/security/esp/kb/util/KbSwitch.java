 ...
 * @generated
 */
public class KbSwitch<T> extends Switch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case KbPackage.APPLICATION_PART:
			{
			...
			case KbPackage.ATTACK_STEP_TYPE:
			{
			...
			case KbPackage.ATTACK_STEP_PROBABILITY:
			{
				AttackStepProbability attackStepProbability = (AttackStepProbability)theEObject;
				T result = caseAttackStepProbability(attackStepProbability);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KbPackage.ATTACK_PATH:
			{
			...
			case KbPackage.ATTACK_MITIGATION:
			{
			...
			case KbPackage.PROTECTION_INSTANTIATION:
			{
			...
			case KbPackage.ATTACKER_TOOL_TYPE:
			{
			...
			case KbPackage.APPLIED_PROTECTION_INSTANTIATION:
			{
			...
			case KbPackage.SECOND_LEVEL_MOTIVATION:
			{
			...
			case KbPackage.SOLUTION_SEQUENCE:
			{
			...
			case KbPackage.APPLICATION_PART_METRIC_SET:
			{
			...
			case KbPackage.FUNCTION_DECLARATION:
			{
			...
			case KbPackage.APPLICATION_PART_SET:
			{
			...
			case KbPackage.PROTECTION_OBJECTIVE:
			{
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Attack Step Probability</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Attack Step Probability</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAttackStepProbability(AttackStepProbability object)
	{
		return null;
	}
