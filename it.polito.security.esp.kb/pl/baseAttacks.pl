...
attackStep(staticallyLocate(Datum, Code), [contentStaticallyRetrieved(Code)], [staticallyLocated(Datum)]) :-
	code(Code),
	datum(Datum),
	arg(1, Code, attacker),
...
attackStep(dynamicallyLocate(Datum, Code), [codeExecuted(Code)], [dynamicallyLocated(Datum)]) :-
	code(Code),
	datum(Datum),
	arg(1, Code, attacker),
	arg(1, Datum, attacker),
