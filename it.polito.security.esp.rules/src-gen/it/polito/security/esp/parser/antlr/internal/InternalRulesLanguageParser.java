package it.polito.security.esp.parser.antlr.internal;
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    				...
            	    				add(
            	    					...
            	    					"rules",
            	    					lv_rules_0_0,
            	    					"it.polito.security.esp.RulesLanguage.Rule");
        ...
        try {
            ...
            state._fsp--;
            					...
            					add(
            						...
            						"conditions",
            						lv_conditions_3_0,
            						"it.polito.security.esp.RulesLanguage.Condition");
            					afterParserOrEnumRuleCall();
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"action",
            						lv_action_7_0,
            						"it.polito.security.esp.RulesLanguage.Action");
            					afterParserOrEnumRuleCall();
                ...
                case 1 :
                    ...
                    state._fsp--;
                    					...
                    					add(
                    						...
                    						"parameters",
                    						lv_parameters_2_0,
                    						"it.polito.security.esp.RulesLanguage.ParameterType");
                    					afterParserOrEnumRuleCall();
