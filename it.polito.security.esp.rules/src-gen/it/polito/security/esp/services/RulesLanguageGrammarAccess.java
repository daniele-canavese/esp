 ...
 */
package it.polito.security.esp.services;
...
public class RulesLanguageGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polito.security.esp.RulesLanguage.Model");
	...
	public class RuleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polito.security.esp.RulesLanguage.Rule");
	...
	public class ConditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polito.security.esp.RulesLanguage.Condition");
	...
	public class FunctionDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.polito.security.esp.RulesLanguage.FunctionDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ParameterTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "it.polito.security.esp.RulesLanguage.ParameterType");
	...
	public class ActionElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "it.polito.security.esp.RulesLanguage.Action");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("it.polito.security.esp.RulesLanguage".equals(grammar.getName())) {
				return grammar;
			}
