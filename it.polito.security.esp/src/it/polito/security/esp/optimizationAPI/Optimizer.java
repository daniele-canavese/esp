...
public interface Optimizer {
	...
	/**
	 * Returns the value assumed by the passed expression, using the values assumed by the variables in the best solution found. 
	 * @param expr The expression that must be evaluated.
	 * @return The value assumed by the expression using the best solution.
	 * @throws OptimizerException Thrown if an exception is raised by a method of the specific optimization program API; the exception embeds the message of the original exception.
	 */
